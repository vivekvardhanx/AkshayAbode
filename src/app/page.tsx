...
import { ArrowRight, Wifi, UtensilsCrossed, WashingMachine, Tv, Bath, Zap, Droplets, Sparkles, Shield, BookUser } from "lucide-react";
...
const MirrorIcon = (props: React.SVGProps<SVGSVGElement>) => (
    <svg
      ...
      {...props}
    >
      <path d="M14.5 2h-5L7 7v10c0 1.1.9 2 2 2h6c1.1 0 2-.9 2-2V7l-2.5-5z" />
      <path d="M7 21h10" />
      <path d="M12 2v2" />
    </svg>
  );
